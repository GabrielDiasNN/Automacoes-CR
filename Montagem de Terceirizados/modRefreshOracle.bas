...
Public Function ObterFingerprintTabelaAtiva(Optional ByVal objWsForcado As Worksheet = Nothing) As String
    On Error GoTo Falha
        ...
        If objWsForcado Is Nothing Then
            ' VUL-08: sem planilha explicita, o fingerprint usa ActiveSheet.
            ' Isso pode produzir diagnostico enganoso se outra aba estiver ativa.
            GravarLogEx "AVISO: ObterFingerprintTabelaAtiva chamado sem planilha explicita -- usando ActiveSheet.", LOG_WARNING
            ...
            If objWs.ListObjects.count = 0 Then Exit Function
                ...
                If objLo.DataBodyRange Is Nothing Then Exit Function
                    ...
                    If lngRCount <= 0 Or lngCCount <= 0 Then Exit Function
                        ...
                        ObterFingerprintTabelaAtiva = "H=" & modUtil.GerarHashDJB2(strBase) & "; R=" & lngRCount & "; C=" & lngCCount & "; S=" & strStampK
                     Exit Function
