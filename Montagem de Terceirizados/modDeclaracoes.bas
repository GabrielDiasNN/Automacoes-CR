...
Public Declare Function GetAsyncKeyState Lib "user32" (ByVal vKey As Long) As Integer
    ...
    Public Const NOTIF_TIPO_AUTO As String = "AUTO"
    Public Const NOTIF_TIPO_ERRO As String = "ERRO"
    Public Const NOTIF_TIPO_ALTERACAO As String = "ALTERACAO"
    Public Const NOTIF_TIPO_ACERTO As String = "ACERTO"
    Public Const NOTIF_TIPO_NENHUMA As String = "NENHUMA"
