    ...
    If Not objWs Is Nothing Then
        ...
        If Len(Trim$(strTempTo)) = 0 Then
            ...
            On Error GoTo 0
                ...
                ' ?? Trava de Seguranca Final: Redirecionamento para Modo de Teste
                ...
                If Len(strTestEmail) > 0 Then
                    ...
                    GravarLogEx "MODO TESTE ATIVO: Redirecionando e-mail de " & strTo & " para " & strTestEmail, LOG_WARNING
