    ...
    for (const item of itens) {
        ...
        try {
            ...
            if (acked) {
                ...
                // ACK nao confirmado = falha, independente da estabilidade do bootstrap.
                // Mensagem pode ter ficado na fila local do Puppeteer sem transmitir ao servidor.
                // O proximo cron reenvia — o risco de duplicata e menor que o de silencio permanente.
                success = false;
                writeLog('WARN', `[BATCH] ${phase_key}: ACK nao confirmado em ${ackAttempts * ACK_WAIT_DELAY_MS / 1000}s — marcando como FALHA para reenvio no proximo ciclo.`);
            }
        } catch (err) {
