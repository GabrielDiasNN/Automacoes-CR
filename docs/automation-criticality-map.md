...
| **`ORB-07`** | **[OBs Restrição Branco](runbooks/obs-restricao-branco-runbook.md)** | **💡 MÉDIA** | **15 min** | A cada 60 minutos, das 05:00 as 19:00, Seg-Sex e Sab das 05:00 as 13:00 (Orchestrator `id=6`, fila `oracle`) | PCP / Expedicao Tinturaria | Perda de visibilidade de OBs classificadas como BRANCO ou BRANCO 2 FIBRAS com peça de finalidade 3 (CORES CLARAS) ou 4 (BRANCO) disponível no depósito 95; a peça elegível deixa de ser aproveitada em tempo hábil. |
