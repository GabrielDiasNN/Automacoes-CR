...
| **`OBP-04`** | **[OBs Paradas Fase](runbooks/obs-paradas-fase-runbook.md)** | **⚠️ ALTA** | **20 min** | Todos os dias às 05:30, 14:30 e 22:30 | PCP / Producao Beneficiamento | Falta de visibilidade de OBs paradas por fase no Beneficiamento, risco de atraso na producao e acumulo de estoque intermediario. |
