...
| **`OBP-04`** | **[OBs Paradas Fase](runbooks/obs-paradas-fase-runbook.md)** | **⚠️ ALTA** | **20 min** | Seg-Sex às 07:00 e 14:00 | PCP / Producao Beneficiamento | Falta de visibilidade de OBs paradas por fase no Beneficiamento, risco de atraso na producao e acumulo de estoque intermediario. |
