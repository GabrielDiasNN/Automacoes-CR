...
| **`ORB-07`** | **[OBs Restrição Branco](runbooks/obs-restricao-branco-runbook.md)** | **💡 MÉDIA** | **15 min** | Ativa a cada 120 minutos; Orchestrator `id=6`, fila `oracle` | PCP / Expedicao Tinturaria | Perda de visibilidade de OBs classificadas como BRANCO ou BRANCO 2 FIBRAS com peça de finalidade 3 (CORES CLARAS) ou 4 (BRANCO) disponível no depósito 95; a peça elegível deixa de ser aproveitada em tempo hábil. |
