...
def upgrade() -> None:
    ...
    with op.batch_alter_table("audit_log", schema=None) as batch_op:
        batch_op.create_index(
            "ix_audit_action_ts", ["action", "timestamp"], unique=False
        )
        batch_op.create_index(
    ...
    with op.batch_alter_table("executions", schema=None) as batch_op:
        batch_op.create_index(
            "ix_exec_auto_status", ["automation_id", "status"], unique=False
        )
        batch_op.create_index(
            "ix_exec_priority_status",
            ["priority", "status", "started_at"],
            unique=False,
        )
        batch_op.create_index(
            "ix_exec_status_started", ["status", "started_at"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_executions_automation_id"), ["automation_id"], unique=False
        )
