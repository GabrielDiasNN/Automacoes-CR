...
ORCHESTRATOR_VERSION = "9.1.1"
WORKER_VERSION = "9.1.1"
ORCHESTRATOR_SCHEMA_VERSION = "a5b212d4418f"
ORCHESTRATOR_CONTRACT_VERSION = "2026.05.21.1"
...
# Mapeamento semântico de exit codes das automações: exit_code -> (status, failure_reason, recovery_action)
EXIT_CODE_MAP = {
    ...
    21: (EXECUTION_STATUS_ERROR, FAILURE_REASON_WHATSAPP_SESSION_EXPIRED, RECOVERY_ACTION_REAUTHENTICATE_WHATSAPP_SESSION),
    24: (EXECUTION_STATUS_ERROR, FAILURE_REASON_CHANNEL_DELIVERY_FAILED, RECOVERY_ACTION_REVIEW_CHANNEL_STATE_BEFORE_REQUEUE),
}
